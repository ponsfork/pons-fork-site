import { A as AbiEncodingLengthMismatchError, c as concatHex, i as isAddress, I as InvalidAddressError, p as pad$1, s as stringToHex, b as boolToHex, a as integerRegex, n as numberToHex, d as bytesRegex, B as BytesSizeMismatchError, e as arrayRegex, U as UnsupportedPackedAbiType, L as LruMap, f as encodeAbiParameters, h as hexToBytes$1, g as secp256k1, l, j as B, _, k as h, m as clsx, y, T, o as getDefaultExportFromCjs, q as concat$1, r as size$2, t as hashTypedData, u as keccak256, v as getAction, w as getCode, x as readContract, z as parseAbi, C as BaseError$1, D as prettyPrint, E as formatGwei, F as decodeErrorResult, G as ContractFunctionZeroDataError, H as ContractFunctionRevertedError, J as ContractFunctionExecutionError, K as hexToBigInt, M as AccountNotFoundError, N as encodeFunctionData, O as estimateFeesPerGas, P as prepareAuthorization, Q as parseAccount, R as getChainId, S as serializeStateOverride, V as formatLog, W as formatTransactionReceipt, X as stringify$1, Y as observe, Z as poll, $ as createClient, a0 as defineChain, a1 as createPublicClient, a2 as http, a3 as isHex, a4 as createStore$1, a5 as set, a6 as del, a7 as get$1, a8 as hashMessage, a9 as slice$2, aa as toHex$2, ab as waitForCallsStatus, ac as stringToBytes, ad as trim, ae as decodeFunctionData, af as hexToString, ag as decodeAbiParameters, ah as erc20Abi, ai as hexToNumber$1, aj as isAddressEqual, ak as decodeEventLog, al as formatUnits, am as parseUnits } from "./index-CwIYqG4e.js";
...
function formatAuthorization(authorization) {
  return {
    ...
    yParity: typeof authorization.yParity !== "undefined" ? numberToHex(authorization.yParity, { size: 1 }) : pad$1("0x", { size: 32 })
  };
}
...
let SHA256$1 = class SHA256 extends HashMD$1 {
  ...
  process(view, offset) {
    ...
    for (let i = 0; i < 64; i++) {
      ...
      const T2 = sigma0 + Maj$1(A, B2, C) | 0;
      H = G;
      G = F;
      F = E;
      E = D + T1 | 0;
...
const sha256$3 = /* @__PURE__ */ createHasher$1(() => new SHA256$1());
...
const sha256 = /* @__PURE__ */ createHasher(() => new SHA2562());
