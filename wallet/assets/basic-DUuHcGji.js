import { i, e as elementStyles, r as resetStyles, a as i$1, b, C as ConnectorController, A as ApiController, O as OptionsController, c as CoreHelperUtil, E as EventsController, R as RouterController, d as ConnectorUtil, f as AssetUtil, g as ConnectionController, S as StorageUtil, h as ConstantsUtil, W as WalletUtil, j as ChainController, k as AssetController, T as ThemeController, l as SnackController, M as ModalController, m as ConstantsUtil$1, w, n as A, o as colorStyles } from "./core-B0gf5v3K.js";
import { n as n$1, c as customElement, o as o$1, r, U as UiHelperUtil, e as e$1, f, a as e$2 } from "./index-CWRTls16.js";
import { bo as requireDijkstra, o as getDefaultExportFromCjs } from "./index-CwIYqG4e.js";
const styles$q = i`
  :host {
    position: relative;
...
const o = /* @__PURE__ */ new WeakMap(), n = e$1(class extends f {
  ...
  update(i2, [s]) {
    var _a;
    const e2 = s !== this.G;
    return e2 && this.rt(void 0), (e2 || this.lt !== this.ct) && (this.G = s, this.ht = (_a = i2.options) == null ? void 0 : _a.host, this.rt(this.ct = i2.element)), A;
  }
  rt(t) {
  ...
  render() {
    ...
    return b`
      ...
      ${isSearch || this.badge ? b`<w3m-all-wallets-search
          ...
          ></w3m-all-wallets-search>` : b`<w3m-all-wallets-list badge=${o$1(this.badge)}></w3m-all-wallets-list>`}
    `;
  }
  onInputChange(event) {
